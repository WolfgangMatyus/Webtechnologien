            ...
            <col class="col">
                ...
                <div class="imp_body">
                    <p>
                        SpitzerMatyus GmbH
                    <br>
                        Robert Spitzer & Wolfgang Matyus
                    <br>
                        A-1200 Wien,
                    <br>
                        Höchstädtplatz 6,
                    <br>
                        Telefon: +43 (0) 33340770
                    <br>
                        technikum-wien.at
                    </p>
                    <p>
                        UID Nr.: ATU 63908436
                    <br>    
                        Firmenbuchnummer: FN303798m
                    <br>
                        Firmenbuchgericht: LGZ Wien
                    <br>
                        Mitgliedschaften bei der Wirtschaftskammerorganisation: WKO Wien
                    <br>
                        Anwendbare Rechtsvorschriften und Zugang dazu: Gewerbeordnung Hotel- und Gastgewerbe
                    <br>
